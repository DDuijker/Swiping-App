...
const Tutorial = () => {
    ...
    const tutorialPages = [
        {
            ...
            illustration: <SearchSvg width={svgSize} height={svgSize} fill={theme.colors.primary} />, // SVG illustration
        },
        {
            titleKey: "tutorial.createGroup.title",
            descriptionKey: "tutorial.createGroup.description",
            illustration: <GroupSvg width={svgSize} height={svgSize} fill={theme.colors.primary} />,
        },
        {
            titleKey: "tutorial.givePreferences.title",
            descriptionKey: "tutorial.givePreferences.description",
            illustration: <HorrorMovieSvg width={svgSize} height={svgSize} fill={theme.colors.primary} />,
        },
        {
            titleKey: "tutorial.swipeToFindMatch.title",
            descriptionKey: "tutorial.swipeToFindMatch.description",
            illustration: <HighFiveSvg width={svgSize} height={svgSize} fill={theme.colors.primary} />,
        },
        {
    ...
    const onHandlerStateChange = (event: any) => {
        if (event.nativeEvent.oldState === 4) { // 4 means the gesture has ended
            ...
            // Snap the translateX back to its initial position
